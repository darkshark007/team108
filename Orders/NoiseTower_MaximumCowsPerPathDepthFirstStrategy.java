...
public class NoiseTower_MaximumCowsPerPathDepthFirstStrategy extends Orders {

	
	public NoiseTower_MaximumCowsPerPathDepthFirstStrategy(RobotController in) { super(in); }
